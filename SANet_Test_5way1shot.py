...
import models.network as SANet
# ==================================================================================
...
parser.add_argument('--data_name', default='', help='miniImageNet|StanfordDog|StanfordCar|CubBird')
parser.add_argument('--mode', default='test', help='train|val|test')
parser.add_argument('--outf', default='./results/SANet')
...
parser.add_argument('--lr', type=float, default=0.05, help='learning rate, default=0.005')
...
model = SANet.define_SANet(which_model=opt.basemodel, num_classes=opt.way_num, neighbor_k=opt.neighbor_k, norm='batch',
