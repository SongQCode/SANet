...
parser.add_argument('--dataset_dir', default='', help='/miniImageNet')
...
model = SANet.define_SA4Net(which_model=opt.basemodel, num_classes=opt.way_num, neighbor_k=opt.neighbor_k, norm='batch', 
